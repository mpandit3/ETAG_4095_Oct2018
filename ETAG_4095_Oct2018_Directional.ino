...
/*
 * Setting serial communication with MP3 player
 */
...
void noiseOn(){
    unsigned int curTime = rtc.getHours() * 100 + rtc.getMinutes();
...
void noiseOff(){
    ...
    if (curTime >= endTime) {
      ...
      serial.println("Speaker Sleeping");
//     } else if (birdIn == 0 && (hh*60)+mm >= endTime) {
//        Serial1.write(playStop, 4);
